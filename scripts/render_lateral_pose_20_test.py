...
const $=id=>document.getElementById(id),d=window.LATERAL20_TEST_REVIEW,s=d.samples,key='lateral20-test-'+d.summary.model_sha256.slice(0,16),saved=JSON.parse(localStorage.getItem(key)||'{{}}'),vt={{accepted:'接受',rejected:'拒绝',accept_after_edit:'修改后接受',uncertain:'不确定'}};let ids=[],at=0;
